...
* New annotation
_jakarta.transaction.Transactional_ and exception
_jakarta.transaction.TransactionalException_
* New annotation
_jakarta.transaction.TransactionScoped_
...
* Interface _jakarta.transaction.UserTransaction_
...
the current thread.".
* Interface
_jakarta.transaction.TransactionManager_ , method _setTransactionTimeout_
...
* New interface
_jakarta.transaction.TransactionSynchronizationRegistry_
* Interface _jakarta.transaction.Synchronization_
...
* Interface _jakarta.transaction.Transaction_ ,
...
* Interface
_jakarta.transaction.TransactionManager_ , method _commit_ , replace the
