...
across different JTA transactions are distinct. Refer to the Jakarta Context Dependency Injection 3.0
...
Specification_ , available at _https://jakarta.ee/specifications/cdi/3.0/cdi-spec-3.0.0-M4.html_
